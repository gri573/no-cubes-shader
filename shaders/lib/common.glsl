...
float norm1(vec2 v) {
    return dot(abs(v), vec2(1));
}
float norm1(vec3 v) {
    return dot(abs(v), vec3(1));
}
float norm1(vec4 v) {
    return dot(abs(v), vec4(1));
}
float norminf(vec2 v) {
    return max(abs(v.x), abs(v.y));
}
float norminf(vec3 v) {
    return max(max(abs(v.x), abs(v.y)), abs(v.z));
}
float norminf(vec4 v) {
